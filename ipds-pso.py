...
def main():
    ...
    lst_of_points = [[19.9320, 50.0580], [19.945, 50.0685],         #lat=50
                     [19.9431, 50.0590], [19.927, 50.0632],         #lng=19
    ...
    right_order = s.gBest
    graph = Graph()
    longitudes , latitudes = graph.upgrade_points(restaurant_loc=restaurant_loc, right_order=right_order, lst_of_points=lst_of_points, petrol_loactions=s.petrol_locations)
    graph.show_graph(longitudes=longitudes, latitudes=latitudes, petrol_locations=s.petrol_locations, restaurant_loc=restaurant_loc, lst_of_points=lst_of_points)
